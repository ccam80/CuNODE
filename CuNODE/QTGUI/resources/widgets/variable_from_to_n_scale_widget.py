...
from QT_designer_source.custom_widgets.variable_from_to_n_scale import Ui_variable_from_to_n_scale
import logging

class variable_from_to_scale_widget(QFrame, Ui_variable_from_to_n_scale):
    ...
    def on_n_change(self):
        n = self.n_entry.toPlainText()
        self.variable_changed.emit(n)
        logging.info(f"To changed to: {n}")
