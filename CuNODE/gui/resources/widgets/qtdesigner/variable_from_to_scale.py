...
class Ui_variable_from_to_scale(object):
    def setupUi(self, variable_from_to_scale):
        ...
        variable_from_to_scale.resize(510, 94)
        ...
        sizePolicy1.setHeightForWidth(self.Scale_box.sizePolicy().hasHeightForWidth())
        self.Scale_box.setSizePolicy(sizePolicy1)
        ...
        sizePolicy2.setHeightForWidth(self.lin_button.sizePolicy().hasHeightForWidth())
        self.lin_button.setSizePolicy(sizePolicy2)
        ...
        sizePolicy2.setHeightForWidth(self.log_button.sizePolicy().hasHeightForWidth())
        self.log_button.setSizePolicy(sizePolicy2)
