...
class Ui_plotController(object):
    def setupUi(self, plotController):
        ...
        self.xAxisGridPlotOptions.setFocusPolicy(Qt.FocusPolicy.TabFocus)
        ...
        self.yAxisGridPlotOptions.setFocusPolicy(Qt.FocusPolicy.TabFocus)
        ...
        self.zAxisGridPlotOptions.setFocusPolicy(Qt.FocusPolicy.TabFocus)
        ...
        self.horizontalLayout = QHBoxLayout(self.freqSelect_f)
        ...
        self.horizontalLayout.addWidget(self.frequency_l)
        ...
        self.horizontalLayout.addWidget(self.frequency_slider)
        ...
        self.currentFrequency_l.setFont(font4)
        ...
        self.horizontalLayout.addWidget(self.currentFrequency_l)

        self.freqAnimateGrid3d_b = QToolButton(self.freqSelect_f)
        self.freqAnimateGrid3d_b.setObjectName(u"freqAnimateGrid3d_b")
        self.freqAnimateGrid3d_b.setPopupMode(QToolButton.ToolButtonPopupMode.MenuButtonPopup)
        self.freqAnimateGrid3d_b.setToolButtonStyle(Qt.ToolButtonStyle.ToolButtonTextBesideIcon)
        self.freqAnimateGrid3d_b.setAutoRaise(False)
        self.freqAnimateGrid3d_b.setArrowType(Qt.ArrowType.NoArrow)

        self.horizontalLayout.addWidget(self.freqAnimateGrid3d_b)
        ...
        self.paramAxisTime3D_options = variable_from_to_scale_widget(self.timeHistory3D_tab)
        self.paramAxisTime3D_options.setObjectName(u"paramAxisTime3D_options")
        sizePolicy.setHeightForWidth(self.paramAxisTime3D_options.sizePolicy().hasHeightForWidth())
        self.paramAxisTime3D_options.setSizePolicy(sizePolicy)
        self.paramAxisTime3D_options.setMinimumSize(QSize(0, 10))
        self.paramAxisTime3D_options.setFocusPolicy(Qt.FocusPolicy.TabFocus)
        self.paramAxisTime3D_options.setFrameShape(QFrame.Shape.StyledPanel)
        self.paramAxisTime3D_options.setFrameShadow(QFrame.Shadow.Raised)
        self.paramAxisTime3D_options.setProperty("variableMax", 10000000.000000000000000)
        self.paramAxisTime3D_options.setProperty("variableMin", -10000000.000000000000000)
        self.paramAxisTime3D_options.setProperty("variableDecimals", 10.000000000000000)
        self.paramAxisTime3D_options.setProperty("fromEntryDefault", 0.000000000000000)
        self.paramAxisTime3D_options.setProperty("toEntryDefault", 1.000000000000000)

        self.verticalLayout_3.addWidget(self.paramAxisTime3D_options)
        ...
        self.timeAxis3d_options.setFocusPolicy(Qt.FocusPolicy.TabFocus)
        ...
        self.amplAxisTime3d_options.setFocusPolicy(Qt.FocusPolicy.TabFocus)
        ...
        self.amplAxisTime3d_options.setProperty("fromEntryDefault", -5.000000000000000)
        self.amplAxisTime3d_options.setProperty("toEntryDefault", 5.000000000000000)
        ...
        self.paramAxisSpec3d_options.setFocusPolicy(Qt.FocusPolicy.TabFocus)
        ...
        self.freqAxisSpec3d_options.setFocusPolicy(Qt.FocusPolicy.TabFocus)
        ...
        self.amplAxisSpec3d_options.setFocusPolicy(Qt.FocusPolicy.TabFocus)
        ...
        self.horizontalLayout_2 = QHBoxLayout(self.fixedParamSelectTime_f_2)
        ...
        self.horizontalLayout_2.addWidget(self.fixedParamSpec_l)
        ...
        self.horizontalLayout_2.addWidget(self.fixedParamSpec_slider)

        self.fixedParamSpec_entry = floatLineEdit(self.fixedParamSelectTime_f_2)
        self.fixedParamSpec_entry.setObjectName(u"fixedParamSpec_entry")
        sizePolicy3 = QSizePolicy(QSizePolicy.Policy.Preferred, QSizePolicy.Policy.Fixed)
        sizePolicy3.setHorizontalStretch(1)
        sizePolicy3.setVerticalStretch(0)
        sizePolicy3.setHeightForWidth(self.fixedParamSpec_entry.sizePolicy().hasHeightForWidth())
        self.fixedParamSpec_entry.setSizePolicy(sizePolicy3)

        self.horizontalLayout_2.addWidget(self.fixedParamSpec_entry)
        ...
        self.horizontalLayout_2.addWidget(self.fixedParamSpecAnimate_button)
        ...
        self.singlePlotStyle_box.setFont(font5)
        ...
        self.singleSpectrogram_button.setFont(font5)
        ...
        self.singleTimeDomain_button.setFont(font5)
        ...
        self.phase2d_button.setFont(font5)
        ...
        self.phase3d_button.setFont(font5)
        ...
        sizePolicy5.setHeightForWidth(self.zAxisSinglePlotOptions.sizePolicy().hasHeightForWidth())
        self.zAxisSinglePlotOptions.setSizePolicy(sizePolicy5)
        ...
        self.param1Select_l.setFont(font6)
        ...
        self.param1ValSelect_dd.setFont(font6)
        ...
        self.param1Animate_button.setFont(font7)
        ...
        sizePolicy5.setHeightForWidth(self.yAxisSinglePlotOptions.sizePolicy().hasHeightForWidth())
        self.yAxisSinglePlotOptions.setSizePolicy(sizePolicy5)
        ...
        sizePolicy5.setHeightForWidth(self.zAxis_l_2.sizePolicy().hasHeightForWidth())
        self.zAxis_l_2.setSizePolicy(sizePolicy5)
        font8 = QFont()
        font8.setPointSize(11)
        font8.setBold(True)
        font8.setStrikeOut(False)
        font8.setKerning(True)
        self.zAxis_l_2.setFont(font8)
        ...
        sizePolicy5.setHeightForWidth(self.xAxis_l_2.sizePolicy().hasHeightForWidth())
        self.xAxis_l_2.setSizePolicy(sizePolicy5)
        self.xAxis_l_2.setFont(font8)
        ...
        sizePolicy5.setHeightForWidth(self.xAxisSinglePlotOptions.sizePolicy().hasHeightForWidth())
        self.xAxisSinglePlotOptions.setSizePolicy(sizePolicy5)
        ...
        sizePolicy5.setHeightForWidth(self.yAxis_l_2.sizePolicy().hasHeightForWidth())
        self.yAxis_l_2.setSizePolicy(sizePolicy5)
        self.yAxis_l_2.setFont(font8)
        ...
        self.Param2Select_l.setFont(font6)
        ...
        self.param2ValSelect_dd.setFont(font6)
        ...
        self.param2Animate_button.setFont(font7)
        ...
        self.paramAxisTime3D_options.from_changed.connect(plotController.update_xSlice)
        self.paramAxisTime3D_options.to_changed.connect(plotController.update_xSlice)
        ...
        self.fixedParamSpec_slider.valueChanged.connect(plotController.set_fixedParam)
        ...
        self.paramAxisTime3D_options.scale_changed.connect(plotController.update_xVar)
        ...
        self.paramAxisTime3D_options.variable_changed.connect(plotController.update_xVar)
        ...
        self.freqAnimateGrid3d_b.released.connect(plotController.animate_fixedparam)
        self.fixedParamTime_slider.sliderMoved.connect(plotController.set_fixedParam)
        self.fixedParamSpec_slider.sliderMoved.connect(plotController.set_fixedParam)

        self.plotSettingsTabs.setCurrentIndex(2)
    ...
    def retranslateUi(self, plotController):
        ...
        self.zAxisGridPlotOptions.setProperty("varDdItems", [
            QCoreApplication.translate("plotController", u"PSD", None),
            QCoreApplication.translate("plotController", u"FFT Phase", None),
            QCoreApplication.translate("plotController", u"Amplitude", None)])
        self.frequency_l.setText(QCoreApplication.translate("plotController", u"Frequency", None))
        self.freqAnimateGrid3d_b.setText(QCoreApplication.translate("plotController", u"Animate", None))
        ...
        self.paramAxisTime3D_options.setProperty("varDdItems", [
            QCoreApplication.translate("plotController", u"Parameter 1", None),
            QCoreApplication.translate("plotController", u"Parameter 2", None)])
        ...
        self.amplAxisSpec3d_options.setProperty("varDdItems", [
            QCoreApplication.translate("plotController", u"PSD", None),
            QCoreApplication.translate("plotController", u"FFT Phase", None)])
        self.fixedParamSpec_l.setText(QCoreApplication.translate("plotController", u"Free Parameter", None))
