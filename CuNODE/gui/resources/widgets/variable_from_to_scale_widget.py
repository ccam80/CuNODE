...
from gui.resources.widgets.qtdesigner.variable_from_to_scale import Ui_variable_from_to_scale
import logging

class variable_from_to_scale_widget(QFrame, Ui_variable_from_to_scale):
    """Contains a drop down menu to select a variable, set some "from" and "to"
    values, and set linear/log scale.
